...
class PostItem extends Component {
	...
	render() {
		const { post, auth, showActions } = this.props;  // we have `this.props.auth` because we brought it in via mapStateToProps. we also have `this.props.post` because we brought it in via `post={post}` in PostFeed.js
